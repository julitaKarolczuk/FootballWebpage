...
namespace SBDProject.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,TeamId,PositionId,PlayingFrom,PlayingTo,Picture")] Player player, HttpPostedFileBase file)
        {
            ...
            ViewBag.PositionId = new SelectList(db.Position, "Id", "Name", player.PositionId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName,TeamId,PositionId,PlayingFrom,PlayingTo,Picture")] Player player, HttpPostedFileBase file)
        {
            if (ModelState.IsValid)
            {
                if (file != null && file.ContentLength > 0)
